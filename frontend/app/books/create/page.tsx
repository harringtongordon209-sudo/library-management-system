...
export default function CreateBookPage() {
    ...
    const [createdBook, setCreatedBook] = useState<BookResponse | null>(null);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await fetch(`/api/titles/${selectedTitleId}/book`, {
                method: "POST",
                headers: {
                ...
                body: JSON.stringify({
                    author: author, // Using "author" exactly as specified
            ...
            if (response.ok) {
                ...
                setError(errData.message || "Failed to add the book. Please try again.");
            }
        } catch (err) {
    ...
    if (createdBook) {
        const selectedTitle = titles.find(
            (t) => t.title_id === createdBook.title_id
        );
            ...
            <div className="max-w-2xl mx-auto p-6">
                <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
                    ...
                    <div className="space-y-3 mb-6">
                        ...
                        <p>
                            <span className="font-semibold text-gray-700">Author:</span> {createdBook.author}
                        </p>
                        <p>
                            <span className="font-semibold text-gray-700">Number of Pages:</span> {createdBook.number_of_pages}
                        </p>
                        <div>
                            ...
                            <ul className="list-disc list-inside mt-2 bg-gray-50 border border-gray-200 rounded-md p-3 space-y-1 font-mono text-sm">
                                {createdBook.created_serial_numbers.map((serial) => (
